    ...
    const template = html`
      ...
      <div class="profile-item1">
        ...
        ${this.user && this.user.avatar ? html`
          <sl-avatar shape="rounded" style="--size: 250px; margin-bottom: 1em;" image=${(this.user && this.user.avatar) ? `${App.apiBase}/images/${this.user.avatar}` : ''}></sl-avatar>
        `:html`
      ...
      <div class="profile-title calign"><h2>${this.user.firstName}'s shared designs</h2><sl-icon name="arrow-down-square" style="font-size: 32px;"></sl-icon></div>
