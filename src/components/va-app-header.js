  ...
  render(){    
    ...
    <sl-drawer class="app-side-menu" placement="left">
      ...
      <nav class="app-side-menu-items">
        ...
        <a href="/designers" @click="${this.menuClick}"> <sl-icon name="people" class="icon-styling" style="font-size: 0.8em;"></sl-icon></sl-icon> Find a designer</a>
        <a href="/profile" @click="${this.menuClick}"> <sl-icon name="person" class="icon-styling" style="font-size: 0.8em;"></sl-icon></sl-icon> Profile</a>
        <a href="#" @click="${() => Auth.signOut()}"> <sl-icon name="box-arrow-in-left" class="icon-styling" style="font-size: 0.8em;"></sl-icon></sl-icon> Sign Out</a>
      </nav>  
    </sl-drawer>
    `
  }
